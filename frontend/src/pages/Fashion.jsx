...
import Galaxy from "../assets/k.jpeg";

import speaker from "../assets/b.jpeg";
import two from "../assets/c.jpeg";
import wine from "../assets/d.jpeg";
import wire from "../assets/e.jpeg";
import head from "../assets/f.jpeg";
import Fridge from "../assets/g.jpeg";
import phone from "../assets/h.jpg";
import Printer from "../assets/i.jpeg";
import stove from "../assets/x.jpeg";
...
const Fashion = () => {
  ...
  const products = [
    { id: 1, name: "Chanel Chance Eau de Parfum", desc: "Chanel Chance Eau de Parfum is a modern classic—an olfactory embodiment of movement and possibility.", price: 149, image: Printer },
    { id: 2, name: "Dolce & Gabbana — The Only One", desc: "The perfect perfume Floral–Gourmand with a touch of powdery warmth .", price: 199, image: Fridge },
    { id: 3, name: "Rose Gold-Tone Watch", desc: "Michael Kors Accessories _ Michael Kors Ritz Rose Gold-Tone Watch _ Color_ Gold _ Size_ Os", price: 180, image: phone },
    { id: 4, name: "YSL Black Heels", desc: "Elegant and timeless YSL black heels crafted from premium leather.", price: 90, image:stove },
    { id: 5, name: "Elegant Trouser & Shirt", desc: "Fashion #Style #WomensFashion #ElegantStyle…", price: 342, image: wine },
    { id: 6, name: "Michael Kors Ritz Rose Gold-Tone Watch", desc: "Michael Kors Accessories _ Michael Kors Ritz Rose Gold-Tone Watch.", price: 26, image: wire },
    { id: 7, name: "Rouge", desc: "Rouge means elegance, passion and confidence_   charms in Rouge Dior 999 velvet finish_ the iconic.", price: 89, image: head },
    { id: 8, name: "Tissot’s Telemeter 1938", desc: "Tissot’s Telemeter 1938 Journeys Back To Its Sports Timekeeping Origin.", price: 34, image: Galaxy },
    { id: 9, name: "strapless silhouette", desc: "Ombre Gradient, blending black to red in a strapless silhouette—ideal for making a bold evening statement.", price: 600, image: two },
    { id: 10, name: "Tissot’s Telemeter 1938", desc: "Tissot’s Telemeter 1938 Journeys Back To Its Sports Timekeeping Origin", price: 26, image: Galaxy },
        ...
        <div className="w-64 border-r pr-4">
          ...
          <div className="mb-6">
            ...
            <ul className="space-y-1 text-sm">
              {[
                "Jewelry", "Dresses", "Accessories", "Tops", "Bottoms", "Outerwear",
                "T-Shirts", "Skirts", "Sweaters", "Pants", "Shorts", "Scarves"
              ].map((item, idx) => (
                <li key={idx}>
          ...
          <div className="mb-6">
            ...
            <ul className="space-y-1 text-sm">
              {[
                "YSL", "Khadi", "Gucci", "Zara", "H&M", "Nike",
                 "Adidas", "Forever 21", "Mango", "Calvin Klein", "Tommy Hilfiger", "Gul Ahmad", "J.", "S&S"
                ].map((brand, idx) => (
                <li key={idx}>
                  <label className="flex items-center gap-2">
                    <input type="checkbox" />
