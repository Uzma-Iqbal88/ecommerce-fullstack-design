...
import Galaxy from "../assets/23.jpeg";

import Printer from "../assets/23.jpeg";
import Earbuds from "../assets/24.jpeg";
import { default as speaker, default as two } from "../assets/26.jpeg";
import wine from "../assets/28.jpeg";
import wire from "../assets/29.jpeg";
import head from "../assets/40.jpeg";
import Fridge from "../assets/41.jpeg";
import phone from "../assets/42.jpeg";
import stove from "../assets/55.jpeg";
...
const Shoes = () => {
  ...
  const products = [
    { id: 1, name: "Cream Chunky Sneakers", desc: "Cozy faux-fur lining, suede-look upper, chunky platform sole; easy pull-on winter boots.", price: 149, image: Printer },
    { id: 2, name: "Black Chunky Combat Boots", desc: "Lace-up ankle boots with lug sole and padded collar; tough, everyday street style.", price: 199, image: Fridge },
    { id: 3, name: "Red Stiletto Pumps with Ankle Strap", desc: "Pointed toe, slim high heel, buckle strap; dressy party/occasion heels.", price: 180, image: phone },
    { id: 4, name: "Blush Block-Heel Ankle-Strap Sandals", desc: "Minimal two-strap design with secure ankle buckle; comfy mid/high block heel.", price: 90, image:stove },
    { id: 5, name: "Black Strappy Block-Heel Sandals", desc: "Thick sole, wrap ankle straps; stable and dressy.", price: 342, image: wine },
    { id: 6, name: "Ivory Braided Strap Flat Sandals", desc: "Woven front strap with flat footbed; light summer sandals.", price: 26, image: wire },
    { id: 7, name: "Beige Shearling-Cuff Ankle Boots", desc: "Cozy faux-fur lining, suede-look upper, chunky platform sole; easy pull-on winter boots.", price: 89, image: head },
    { id: 8, name: "Beige & Black Cap-Toe Slingback Pumps", desc: "Low block heel with contrast toe cap; classic, Chanel-inspired look for work or events.", price: 34, image: Earbuds },
    { id: 9, name: "Mint & White Retro Low-Top Sneakers", desc: "Sporty casual trainers with contrast panels; everyday wear.", price: 600, image: two },
    { id: 10, name: "Blush Block-Heel Ankle-Strap Sandals", desc: "Minimal two-strap design with secure ankle buckle; comfy mid/high block heel.", price: 26, image:  stove },
  ...
  return (
    <div className="p-8">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-800"> Category Electronics Products </h1>
        ...
        <div className="w-64 border-r pr-4">
          ...
          <div className="mb-6">
            ...
            <ul className="space-y-1 text-sm">
              {[
                "Sneakers",  "Boots",  "Sandals",  "Flats",  "Heels",
                  "Loafers",  "Running Shoes",  "Formal Shoes",  "Casual Shoes"
              ].map((item, idx) => (
                <li key={idx}>
          ...
          <div className="mb-6">
            ...
            <ul className="space-y-1 text-sm">
              {[
                "Nike","Adidas","Puma","Reebok","Converse",  "Vans",  "New Balance",  "Skechers",  "Clarks",
